          ...
          <div className="flex w-full flex-row justify-right justify-between gap-8">
            ...
            <div className="bg-gray-200 rounded p-5 flex-1">
              <div className="flex gap-8">
                ...
                <div className="py-5">Connect</div>
              </div>
            ...
            <div className="bg-gray-200 rounded p-5 flex-1">
              <div className="flex gap-8">
                ...
                <div className="py-5">Educate</div>
              </div>
