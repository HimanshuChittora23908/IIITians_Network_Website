    ...
    <div className="bg-gray-900 bg-contain flex justify-between">
      <div className="m-32">
        ...
        <div className="flex my-4">
          <button className="text-white mr-12 text-xl bg-gray-800 px-8 py-2 shadow-button_custom rounded-3xl flex">
            <div className="w-5 h-5 mr-2 mt-0.5">
              <Image src={info} alt="image" />
            </div>
            About Us
          </button>
          <button className="text-white text-xl bg-gray-800 px-8 py-2 shadow-button_custom rounded-3xl flex">
            Video{" "}
            <div className="w-8 h-8 ml-2">
              <Image src={triangle_right} alt="image" />
            </div>
          </button>
          <br />
        </div>
        <div className="flex bg-white rounded-3xl item-center py-2 mr-5">
          <div>
            <h1 className="pl-6 mr-6 text-xl font-medium">Join Us Now : </h1>
          </div>
          <div>
            <input
              type="text"
              placeholder="Enter Email"
              className="py-1 w-72 border-b-2 border-gray-900"
            />
          </div>
        </div>
      </div>
