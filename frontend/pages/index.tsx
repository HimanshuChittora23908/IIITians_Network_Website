  ...
  return (
    ...
    <div className="bg-gray-900 bg-contain flex justify-between">
      <div className="m-32">
        ...
        <div className="flex">
        <div className="shadow-2xl"><button className="text-white mr-8 text-xl bg-gray-800 px-6 py-2 rounded-3xl flex"><div className="w-4 h-4 mr-1"><Image src={info} /></div>About Us</button></div>
        <button className="text-white text-xl">Video</button><br />
        </div>
        <input type="text" />
      </div>
